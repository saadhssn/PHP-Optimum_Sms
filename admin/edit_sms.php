...
<?php 
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
      ...
      mysqli_query($connection, "UPDATE message SET create_date='$create_date', category_id='$category_id', title='$title', slug='$slug', content='$content', meta_description='$meta_description', meta_keyword='$meta_keyword' WHERE id=$id ") or die(mysqli_error($connection));
              ...
              <div class="row column-seperation">
                <div class="col-md-6">
                  <h4>Basic Information</h4>            
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <select name="category_id" id="category_id" class="form-control">
                          ...
                          ?>
                          <option value="<?php echo $viewAllCategories['id'] ?>" <?php if($row['category_id'] == $viewAllCategories['id']) { echo "selected"; } ?> ><?php echo $viewAllCategories['title']; ?></option>
                        <?php } ?>
                        </select>
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <textarea name="content" id="content" rows="8" class="form-control" placeholder="SMS">
                ...
                <div class="col-md-6">
                  ...
                  <h4>Meta Information</h4>
                    <div class="row form-row">
                      <div class="col-md-12">
                        <textarea name="meta_description" id="meta_description" rows="8" class="form-control" placeholder="Meta Descriptions"><?php echo $row['meta_keyword']; ?></textarea>
                      </div>
                    </div>
                    <div class="row form-row">
                      <div class="col-md-12">

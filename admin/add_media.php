...
<?php 
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
      ...
      if ($hasFileuploaded)
      {
        mysqli_query($connection, "INSERT INTO media(create_date, media_type, title, slug, description, embed_code, media_img, status, meta_description, meta_keyword)
              VALUES('$create_date', '$media_type', '$title', '$slug', '$description', '$embed_code', '$fileName', '$status', '$meta_description', '$meta_keyword')") or die(mysqli_error($connection));
       ...
       <div class="form-actions">
        ...
        <script type="text/javascript">
          var frmvalidator  = new Validator("formAdd");
              ...
              frmvalidator.addValidation("media_type","dontselect=none","Select Media Type");
        </script>

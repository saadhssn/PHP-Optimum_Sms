...
<?php 
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
      ...
      mysqli_query($connection, "INSERT INTO message(create_date, category_id, title, slug, content, status, meta_description, meta_keyword)
            VALUES('$create_date', '$category_id', '$title', '$slug', '$content', '$status', '$meta_description', '$meta_keyword')") or die(mysqli_error($connection));
...
<!-- END SIDEBAR HERE -->
    ...
    <div class="content">
       ...
       <div class="form-actions">
          ...
          <a href="sms.php"p class="btn btn-primary btn-cons" type="button"><i class="fa fa-times"></i> Cancel </a>
        </div>
        </div>
      </div>
                </div>
    ...
    <script type="text/javascript">
            ...
            frmvalidator.addValidation("category_id","req","Select Category Should't be empty");
            frmvalidator.addValidation("title","req","Title Should't be empty");
            frmvalidator.addValidation("slug","req","Slug Should't be empty");
            frmvalidator.addValidation("content","req","SMS Should't be empty");
        </script>

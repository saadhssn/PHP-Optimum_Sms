                            ...
                            <tr>
                                ...
                                <td>
                                	<?php if ($row['status'] == 'DEACTIVE'): ?>
                                    	<a class="singleStatus" href="sms_status.php?id=<?php echo $row['id']; ?>" > <span class="label label-important btn-small"><i class="fa fa-thumbs-o-down"></i></span></a>
                                    <?php else: ?>
                                       	<a class="singleStatus" href="sms_status.php?id=<?php echo $row['id']; ?>"> <span class="label label-info btn-small"><i class="fa fa-thumbs-o-up"></i></span> </a>
                                     <?php endif ?>
                                </td>
                                <td>
                                    <a href="edit_sms.php?id=<?php echo $row['id']; ?>" class="label label-info"> <i class="fa fa-edit"></i></a>
                                    <a href="delete_sms.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you Pakka, You want to delte this?')" class="label label-important singleDelete"> <i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>

            ...
            <article>
                <ul class="list-unstyled list-inline">
                    <?php 
                            ...
                            $getLatestImage = mysqli_query($connection, "SELECT * FROM media WHERE status='ACTIVE' ORDER BY id DESC LIMIT 8") or die(mysqli_error($connection));
                            while ($viewLatestImage = mysqli_fetch_array($getLatestImage)) {
                        ?>
                        
                                <li><img src="uploads/<?php echo $viewLatestImage['media_img']; ?>" width="120" class="img-thumbnail" alt="<?php echo $viewLatestImage['title']; ?>"></li>
                        <?php } ?>
                </ul>
            </article>
        </section>

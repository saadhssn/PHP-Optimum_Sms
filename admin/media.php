                       ...
                       <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="../uploads/<?php echo $row['media_img']; ?>" width="100" class="img-thumbnail" alt="<?php echo $row['title']; ?>"></td>
                                <td>
                                    <?php if ($row['status'] == 'DEACTIVE'): ?>
                                        <a class="singleStatus" href="media_status.php?id=<?php echo $row['id']; ?>" > <span class="label label-important btn-small"><i class="fa fa-thumbs-o-down"></i></span></a>
                                    <?php else: ?>
                                       <a class="singleStatus" href="media_status.php?id=<?php echo $row['id']; ?>"> <span class="label label-info btn-small"><i class="fa fa-thumbs-o-up"></i></span> </a>
                                    <?php endif ?>
                                </td>
                                <td>
                                    <a href="edit_media.php?id=<?php echo $row['id']; ?>" class="label label-info"> <i class="fa fa-edit"></i></a>
                                    <a href="delete_media.php?id=<?php echo $row['id']; ?>" onclick="return confirm('are you sure want to delete this?')" class="label label-important singleDelete"> <i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
